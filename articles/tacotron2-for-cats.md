...
:::message
🐾 **猫でもわかるTTSシリーズ**(全28本) ― [目次](https://zenn.dev/nnn112358/articles/tts-for-cats-index) ／ 前: [Tacotron](https://zenn.dev/nnn112358/articles/tacotron-for-cats) ／ 次: [音響モデル(FastSpeech 2 等)](https://zenn.dev/nnn112358/articles/acoustic-model-for-cats)
:::
