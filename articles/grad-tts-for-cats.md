---
title: "猫でもわかるGrad-TTS ― 拡散モデルで「ノイズからメルを彫り出す」TTS"
emoji: "🌫️"
type: "tech"
topics: ["tts", "音声合成", "機械学習", "深層学習", "拡散モデル"]
published: false
---
...
エンコーダは [Glow-TTS](https://zenn.dev/nnn112358/articles/glow-tts-for-cats) と同一構造(3層 Conv pre-net + Transformer 6層)。アライメントは **[MAS](https://zenn.dev/nnn112358/articles/mas-for-cats)** で教師なし学習。継続長予測器も同じ 2層 Conv 構成。合計 **7.2M パラメータ**。
...
Grad-TTS と [Glow-TTS](https://zenn.dev/nnn112358/articles/glow-tts-for-cats) はエンコーダと MAS を共有していますが、デコーダの生成戦略が対照的です。
...
Grad-TTS は **拡散モデル系TTS の起点**です。後継の DiffSinger は「浅い拡散」(エンコーダ出力から途中のステップで開始)で推論を高速化。NaturalSpeech 2/3 は拡散をコーデックトークンの潜在空間で行い、さらにスケール。一方 [Flow Matching](https://zenn.dev/nnn112358/articles/flow-matching-for-cats) は拡散の「曲がった経路」を直線化し、[F5-TTS](https://zenn.dev/nnn112358/articles/f5-tts-for-cats) のような簡潔なモデルを生みました。
...
- 関連記事: [猫でもわかるGlow-TTS](https://zenn.dev/nnn112358/articles/glow-tts-for-cats) / [猫でもわかるMAS](https://zenn.dev/nnn112358/articles/mas-for-cats) / [猫でもわかるFlow Matching](https://zenn.dev/nnn112358/articles/flow-matching-for-cats) / [猫でもわかるF5-TTS](https://zenn.dev/nnn112358/articles/f5-tts-for-cats) / [猫でもわかるVITS](https://zenn.dev/nnn112358/articles/vits-for-cats)

:::message
🐾 **猫でもわかるTTSシリーズ**(全32本) ― [目次](https://zenn.dev/nnn112358/articles/tts-for-cats-index) ／ 前: [VALL-E](https://zenn.dev/nnn112358/articles/valle-for-cats) ／ 次: [MaskGCT](https://zenn.dev/nnn112358/articles/maskgct-for-cats)
:::
