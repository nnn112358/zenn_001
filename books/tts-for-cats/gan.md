...
[VAE(V)](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/vae)、[Flow(F)](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/flow)ときたので、いよいよVITSを構成する「**VAE + Flow + GAN**」の最後のひとつ、**GAN(敵対的生成ネットワーク / Generative Adversarial Network)** です。
...
| **VAE** | 速い | 近似(ELBO) | 安定だが**ぼやけやすい**(→[VAE](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/vae)) |
