...
[Tacotron 2](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/tacotron2) は人間レベルの音質(MOS 4.53)に到達しましたが、**自己回帰**(1フレームずつ順に生成)ゆえの2つの弱点がありました。
...
FastSpeech は「**Attention に任せず、継続長を明示予測する**」という発想を確立しました。[Glow-TTS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/glow-tts) は MAS でアライメントを最適化してから Duration Predictor に落とし込み、[VITS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/vits) は SDP でリズムの確率的制御まで到達しました。FastSpeech が示した「継続長を陽に扱う」路線は、現代TTS の基本設計になっています。
...
- 関連する章: [Tacotron 2](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/tacotron2) / [音響モデル](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/acoustic-model) / [Glow-TTS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/glow-tts) / [VITS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/vits) / [MAS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/mas) / [SDP](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/sdp)
