...
[猫でもわかるFlow Matching](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/flow-matching)の応用として、いま人気の **F5-TTS**(2024)を見ます。名前は "**F**airytaler that **F**akes **F**luent and **F**aithful speech with **F**low matching"(Fが5つ)。
...
これまで見た音響モデル([→記事](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/acoustic-model))は、「各音素が何フレーム続くか」を決める **継続長予測器** や、テキストと音の対応をとる **アライメント([MAS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/mas)等)** が必須でした。
...
- 関連記事: [猫でもわかるFlow Matching](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/flow-matching) / [猫でもわかるzero-shot TTS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/zero-shot) / [猫でもわかるVocos(ConvNeXt)](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/vocos) / [VITSから見るTTS 10系統マップ](https://zenn.dev/nnn112358/articles/tts-lineage-map-from-vits)
