...
[猫でもわかるLLM TTS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/llm-tts) で「音声を離散トークンにして、言語モデルで生成する」というパラダイムを紹介しました。その**起点になったモデル**が **VALL-E**(2023, Microsoft）です。
...
- [EnCodec](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/encodec) の8層 RVQ トークンを、**AR(第1層)+ NAR(第2〜8層)** の2段 Transformer で生成。
...
1. 音声を **[EnCodec](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/encodec)** で**離散トークンの行列**にする(75Hz × 8コードブック = 10秒で 750×8 トークン)。
...
[LLM TTS の記事](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/llm-tts)で紹介した **AR+NAR 方式**の原点です。
...
第2〜8層は**音質の細部**(テクスチャ・明瞭さ）を補います。RVQ の構造上、上位層ほど粗く、下位層ほど細かい残差を表すからです([→EnCodec の記事](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/encodec))。
...
大量のデータで学習することで、**プロンプトの話者特徴を in-context で捉え、指定テキストをその声で生成**する能力が自然に身につきます。これが [zero-shot TTS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/zero-shot) の始まりです。
...
- **SoundStorm / MaskGCT**: マスク予測方式（[→LLM TTS 記事](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/llm-tts)参照）
- **[Fish-Speech](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/fish-speech)**: DualAR + GFSQ（RVQ 自体を捨てた）
- **[Qwen3-TTS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/qwen3-tts)**: Multi-Token Prediction + LLM 統合
...
VALL-E は「メル回帰 → トークン言語モデル」というパラダイムシフトを起こし、[LLM TTS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/llm-tts) 全体の土台を築きました。
...
- 関連記事: [猫でもわかるLLM TTS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/llm-tts) / [猫でもわかるEnCodec](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/encodec) / [猫でもわかるzero-shot TTS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/zero-shot) / [猫でもわかるFish-Speech](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/fish-speech) / [猫でもわかるQwen3-TTS](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/qwen3-tts) / [VITSから見るTTS 10系統マップ](https://zenn.dev/nnn112358/articles/tts-lineage-map-from-vits)
