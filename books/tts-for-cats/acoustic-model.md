...
これまでの「猫でもわかる」シリーズで、TTSの入口([G2P](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/g2p))と出口([HiFi-GAN](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/hifigan)などのボコーダ)、その間の[メルスペクトログラム](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/mel-spectrogram)を見てきました。
...
- 関連記事: [猫でもわかるG2P](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/g2p) / [猫でもわかるメルスペクトログラム](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/mel-spectrogram) / [猫でもわかるHiFi-GAN](https://zenn.dev/nnn112358/books/tts-for-cats/viewer/hifigan) / [VITSから見るTTS 10系統マップ](https://zenn.dev/nnn112358/articles/tts-lineage-map-from-vits)
